...
<html>
    ...
    <body >
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-danger" style="font-weight: 900;" href="index.php"> <i class="fa fa-database mr-2 rotate-n-15"></i> SELAMAT DATANG DI ALFAMIDI </a>
            </div>
        </nav>
        ...
        <style>
            body {
                background-image: url('assets/img/alfamidi.jpg');
