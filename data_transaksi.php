        ...
        for ($i=2; $i<=$baris; $i++) {
            for($c=1; $c<=$column; $c++){
                $value[$c] = $data->val($i, $c);
                    ...
                    $temp_date = date('y/m/d', strtotime($value[1]));
                    $id_transaksi = $value[2];
                    $produkIn = $value[3];
                    ...
                    $produkIn = str_replace(",   ", ",", $produkIn);
                    $produkIn = str_replace(",    ", ",", $produkIn);
                    $sql = "INSERT INTO transaksi (transaction_date, id_transaksi, produk) VALUES ";
                    $value_in = array();
                    $sql .= " ('$temp_date', '$id_transaksi', '$produkIn')";
...
if(isset($_POST['delete'])){
    ...
    // $sql1 = "DELETE FROM itemset1";
    // $db_object->db_query($sql1);
    // $sql2 = "DELETE FROM itemset2";
    // $db_object->db_query($sql2);
    // $sql3 = "DELETE FROM itemset3";
    // $db_object->db_query($sql3);
    // $sql4 = "DELETE FROM confidence";
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Daftar Data Transaksi</h6>
            ...
            <thead class="bg-danger text-white">
				...
				?>
                        <tr>
                            ...
                            <td class='text-center'> <?= $row['id_transaksi'] ?></d>
                            <td> <?= $row['produk'] ?></td>
